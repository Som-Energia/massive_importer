from pony.orm import Optional, db_session, select
from massive_importer.models.importer import Event, ImportFile
import _json, json
...
def populate_impFile_database():
    imFile1 = ImportFile(etag="d41d8cd98f00b204e9800998ecf8427e", name="object.txt", size="17", msg="")
    imFile2 = ImportFile(etag="d41d8cd98f00b204e9800998ecf8427a", name="asd.txt", size="6", msg="")
    imFile3 = ImportFile(etag="00251585078848321d4e3ed5c3e699a2", name="diagrama.zip", size="2084", msg="")
